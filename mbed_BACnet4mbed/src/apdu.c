    ...
    if (apdu) {
        ...
        switch (apdu[0] & 0xF0) {
            case PDU_TYPE_CONFIRMED_SERVICE_REQUEST:
							EVRECORD2(BACNET_PDU_TYPE_CONFIRMED, PDU_TYPE_CONFIRMED_SERVICE_REQUEST, 0);
            ...
            case PDU_TYPE_UNCONFIRMED_SERVICE_REQUEST:
							EVRECORD2(BACNET_PDU_TYPE_CONFIRMED, PDU_TYPE_UNCONFIRMED_SERVICE_REQUEST, 0);
            ...
            case PDU_TYPE_SIMPLE_ACK:
							EVRECORD2(BACNET_PDU_TYPE_CONFIRMED, PDU_TYPE_SIMPLE_ACK, 0);
                invoke_id = apdu[1];
            ...
            case PDU_TYPE_COMPLEX_ACK:
							EVRECORD2(BACNET_PDU_TYPE_CONFIRMED, PDU_TYPE_COMPLEX_ACK, 0);
            ...
            case PDU_TYPE_SEGMENT_ACK:
							EVRECORD2(BACNET_PDU_TYPE_CONFIRMED, PDU_TYPE_SEGMENT_ACK, 0);
                /* FIXME: what about a denial of service attack here?
                   we could check src to see if that matched the tsm */
                tsm_free_invoke_id(invoke_id);
                break;
            case PDU_TYPE_ERROR:
							EVRECORD2(BACNET_PDU_TYPE_CONFIRMED, PDU_TYPE_ERROR, 0);
                invoke_id = apdu[1];
                service_choice = apdu[2];
                len = 3;
            ...
            case PDU_TYPE_REJECT:
							EVRECORD2(BACNET_PDU_TYPE_CONFIRMED, PDU_TYPE_REJECT, 0);
                invoke_id = apdu[1];
                reason = apdu[2];
                if (Reject_Function)
                ...
                break;
            case PDU_TYPE_ABORT:
							EVRECORD2(BACNET_PDU_TYPE_CONFIRMED, PDU_TYPE_ABORT, 0);
                server = apdu[0] & 0x01;
                invoke_id = apdu[1];
                reason = apdu[2];
                if (Abort_Function)
                ...
                break;
            default:
							EVRECORD2(BACNET_PDU_TYPE_UNKNOWN, 0, 0);
                break;
        }
    }
    return;
